		...
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					...
					<br> <br> <br>
					<!-- player form start -->
					<div id="playerform" class="animated rotateIn">
						<div class="card ">
					...
					<!-- show page -->
					<div id="showpage" class="animated flipInX ">
						<div class="card ">
	...
	function ajaxPost() {
		...
		function OnError(xhr, errorType, exception) {
		    ...
		    try {
		        ...
		        $("#postResultDiv").append("<div><b>" + errorType + " " + exception + "</b></div>");
		        $("#postResultDiv").append("<div><u>Exception</u>:<br /><br />" + responseText.ExceptionType + "</div>");
		        $("#postResultDiv").append("<div><u>StackTrace</u>:<br /><br />" + responseText.StackTrace + "</div>");
		        $("#postResultDiv").append("<div><u>Message</u>:<br /><br />" + responseText.Message + "</div>");
		    } catch (e) {
		        responseText = xhr.responseText;
		        $("#postResultDiv").html(responseText);
		    }
		    $("#postResultDiv").dialog({
	 ...
	 function resetData(){
        ...
        // player form 
    	 $('#playerlink').click(function () {
    	      ...
    	      $.ajax({
					type: 'GET',
					url: '${pageContext.request.contextPath }/getTeams',
					success: function(result) {
						//var result = JSON.parse(result);
						 var teamInfo = '<option value="" disabled="" selected="">Choose Team</option>';
							for(var i = 0; i < result.length; i++) {
				  				teamInfo += '<option value =' + result[i].name  + '>' + result[i].name + '</option>';
							}
						  $('#team').html(teamInfo);
    	    ...
    	    $("#palyerformapp").submit(function(event) {
    			// Prevent the form from submitting via the browser.
    		...
    		function ajaxPost() {
    			...
    			$.ajax({
    				type: "POST",
    				contentType: "application/json",
    				url : '${pageContext.request.contextPath}/addplayer/'+team,
    	    ...
    	    $('#showlink').click(function () {
    	      ...
    	      $("#team1").change(function () {
      	      ...
      	      function generateTable() {
      	        ...
      	        var teamName = $("#team1 option:selected").val();
      	        //console.log(players);
      	        $.ajax({
					type: 'GET',
					url: '${pageContext.request.contextPath }/getplayers/' +teamName ,
...
//playertableInfo += '<td>' + '<form class="text-center" style="color: #757575;"id="updatetableapp">'+'<button type="submit" name="playerId" value="'+players[i].id+'" class="btn btn-primary playerId">Update</button>'+'</form>'+'</td>'+'</tr>';
        ...
        /*   $(document).on('submit', 'form', function(event) {
  			var $form = $(this);
  // Now you can navigate around the form
  			var aValue = $form.find('[name="playerId"]').val();
  			console.log(aValue);
          }); */
    	  ...
    	  console.log(pid);
          //event.preventDefault();
    	  //$(".playerId").change(function (event) {	  
    	  //event.preventDefault();
    	  //var playerId =  $(this).serialize();
