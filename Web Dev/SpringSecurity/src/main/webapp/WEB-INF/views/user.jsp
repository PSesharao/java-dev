				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent-7">
					<ul class="navbar-nav mr-auto">
						<li class="nav-item active"><a class="nav-link"
							href="/secure/">Home <span class="sr-only">(current)</span></a></li>
						<li class="nav-item"><a class="nav-link" href="/secure/user">User</a>
						</li>
						<li class="nav-item"><a class="nav-link" href="/secure/admin">Admin</a>
						</li>
						<li class="nav-item"><a class="nav-link" href="/secure/guest">Guest</a>
						</li>
					</ul>
					<ul>
					...
					<div class="row">
						...
						<div class="col-md-12 mb-4 white-text text-center">
							<h1
								...
								data-wow-delay="0.3s">
								<strong>Spring Security Intro</strong>
							</h1>
