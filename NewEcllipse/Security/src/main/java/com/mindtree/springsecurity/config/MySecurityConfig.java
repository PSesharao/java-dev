...
public class MySecurityConfig extends WebSecurityConfigurerAdapter {
	...
	/*	http.authorizeRequests()
				 ...
				 * .antMatchers("/admin").hasAnyRole("ADMIN").anyRequest().authenticated().and()
				 * .formLogin()
		...
		.loginPage("/login").defaultSuccessUrl("/home").permitAll().and().logout().logoutSuccessUrl("/login?logout=true").permitAll()
		.and().csrf().disable();
