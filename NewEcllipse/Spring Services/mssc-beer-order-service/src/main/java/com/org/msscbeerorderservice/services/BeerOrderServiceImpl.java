...
import com.org.msscbeerorderservice.domain.BeerOrder;
import com.org.msscbeerorderservice.domain.Customer;
import com.org.msscbeerorderservice.domain.OrderStatusEnum;
...
import com.org.msscbeerorderservice.web.mappers.BeerOrderMapper;
import com.org.msscbeerorderservice.web.model.BeerOrderDto;
import com.org.msscbeerorderservice.web.model.BeerOrderPagedList;
...
public class BeerOrderServiceImpl implements BeerOrderService {
	...
	public BeerOrderPagedList listOrders(UUID customerId, Pageable pageable) {
		...
		if (customerOptional.get(0) != null) {
			Page<BeerOrder> beerOrderPage = beerOrderRepository.findAllByCustomer(customerOptional.get(0), pageable);
