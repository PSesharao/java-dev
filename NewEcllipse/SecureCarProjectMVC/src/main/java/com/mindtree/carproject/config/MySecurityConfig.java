...
class MySecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers("/shop").hasAnyRole("USER", "ADMIN").antMatchers("/color").hasAnyRole("ADMIN").antMatchers("/brand").hasAnyRole("ADMIN")
		.antMatchers("/showroom").hasAnyRole("ADMIN")
		.antMatchers("/preparemodel").hasAnyRole("ADMIN")
		.antMatchers("/solditems").hasAnyRole("ADMIN")
		.antMatchers("/model").hasAnyRole("ADMIN").anyRequest()
