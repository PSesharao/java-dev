		...
		<main>
            ...
            <div class="card card-cascade cascading-admin-card user-card">
              ...
              <div class="admin-up d-flex justify-content-start">
                ...
                <div class="data">
                  <h5 class="font-weight-bold dark-grey-text">Product - <span class="text-muted">Add your Product
                      </span></h5>
                </div>
              </div>
              <!-- Card Data -->
			...
			<form class="text-center" style="color: #757575;"
                ...
                <div class="row">
                  ...
                  <div class="col-lg-4">
                    <div class="md-form form-sm mb-0">
                      ...
                      <input type="text" id="productname" class="form-control " name="name"> <label
                        for="productname">Name
                      </label>
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-lg-4"></div>
                  <div class="col-lg-4">
                    <div class="invalid-tooltip" id="productname_error_message">
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-lg-4"></div>
                  <div class="col-lg-4">
                    <select class="mdb-select md-form" searchable="Search here.." id="catageoryDropdown" name="catageory" >
                ...
                <div class="col-lg-4"></div>
                  <div class="col-lg-4">
                    <div class="md-form form-sm mb-0">
                      ...
                      <input type="text" id="productprice" class="form-control " name="price"> <label
                        for="productprice">Purchase
                        Price
                      </label>
                    </div>
                  </div>
                ...
                <div class="row">
                  ...
                  <div class="row">
                    <div class="col-lg-4"></div>
                    <div class="col-lg-4">
                      <div class="invalid-tooltip" id="image_error_message">
                      </div>
                    </div>
                  </div>
                ...
                <div class="row">
                  <div class="col-lg-4"></div>
                  <div class="col-lg-4">
                    <button class="btn btn-outline-info btn-rounded btn-block z-depth-1 my-4 waves-effect col-sm-12"
