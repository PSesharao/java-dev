							...
							<div class="admin-up d-flex justify-content-start">
								...
								<div class="data">
									<h5 class="font-weight-bold dark-grey-text">
										Register- <span class="text-muted">Register Brand</span>
									</h5>
								</div>
							</div>
							<!-- Card Data -->
										...
										<div class="col-lg-4">
											<div class="md-form form-sm mb-0">
												...
												<input type="text" id="brandname" class="form-control "
													name="name"> <label for="brandname">Brand
													Name</label>
											</div>
										</div>
									</div>
									...
									$
											.ajax({
												...
												success : function(result) {
													var post = "<p>"
															+ "Brand Post Successfull! <br>"
															+ "Brand's Info:<br> Brand Registration Number = "
															+ result.id
															+ "<br> Brand Name = "
															+ result.name
															+ "</p>";
